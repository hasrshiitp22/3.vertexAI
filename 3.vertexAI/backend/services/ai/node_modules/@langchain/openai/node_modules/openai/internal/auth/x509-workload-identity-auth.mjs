...
import { isApprovedX509Client, findX509OAuthError, isRetryableX509IssuerError, isTransientX509ConnectionError, } from '#x509-transport-state';
...
export class X509WorkloadIdentityAuth {
    ...
    constructor(identity, transport, organization, project) {
        ...
        __classPrivateFieldSet(this, _X509WorkloadIdentityAuth_refreshBufferMs, __classPrivateFieldGet(this, _X509WorkloadIdentityAuth_configuredRefreshBufferMs, "f") ?? DEFAULT_REFRESH_BUFFER_MS, "f");
    }
